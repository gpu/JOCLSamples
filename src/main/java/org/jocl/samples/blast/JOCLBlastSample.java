...
/**
 * A basic sample showing how to use JOCLBlast to perform a SGEMM
 */
public class JOCLBlastSample
{
    ...
    public static void main(String args[])
    {
        ...
        //cl_context ct = new cl_context();
        //clGetEventInfo(event, CL.CL_EVENT_CONTEXT, Sizeof.cl_context, Pointer.to(ct), null);
