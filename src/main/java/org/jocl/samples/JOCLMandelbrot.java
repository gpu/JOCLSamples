...
public class JOCLMandelbrot
{
     ...
     */
    private DefaultListModel<Rectangle2D> viewListModel;
    
    /**
     * The list displaying the views (areas)
     */
    private JList<Rectangle2D> viewList;
    ...
    private void initCL()
    {
        ...
        String source0 = 
            readFile("src/main/resources/kernels/QuadFloat.cl");
        String source1 = 
            readFile("src/main/resources/kernels/QuadFloatMandelbrot.cl");
    ...
    private JComponent createViewPanel()
    {
        ...
        viewListModel = new DefaultListModel<Rectangle2D>();
        viewList = new JList<Rectangle2D>(viewListModel);
